<div class="bg-white rounded-lg p-6 shadow-lg" wire:ignore>
        ...
        @elseif ($chartType === 'bar')
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select wire:model.live="xAxis" id="xAxis" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <select wire:model.live="yAxis" id="yAxis" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
    ...
    <!-- Chart Display Area -->
    <div class="relative bg-gray-50 rounded-lg h-96">
